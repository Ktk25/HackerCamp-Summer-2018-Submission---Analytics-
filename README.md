...
uni.tail(10)
```
The above function returns a new dataset having **62 rows** consisting the unique names without any duplication. There is no repetion of same date of birth in the case of totally same names.       
